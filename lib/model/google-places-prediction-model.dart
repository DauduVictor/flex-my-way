...
class GooglePlacesPredictionModel {
  ...
  factory GooglePlacesPredictionModel.fromJson(Map<String, dynamic> json) => GooglePlacesPredictionModel(
    predictions: json['predictions'] != null ? List<Prediction>.from(json['predictions'].map((x) => Prediction.fromJson(x))) : null,
    status: json["status"],
  );
...
class StructuredFormatting {
  ...
  factory StructuredFormatting.fromJson(Map<String, dynamic> json) => StructuredFormatting(
    ...
    mainTextMatchedSubstrings: json["main_text_matched_substrings"] != null ?
      List<MatchedSubstring>.from(json["main_text_matched_substrings"].map((x) => MatchedSubstring.fromJson(x))) : null,
