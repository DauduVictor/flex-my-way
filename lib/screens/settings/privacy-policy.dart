  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Text(
          textName,
          style: textTheme.headlineSmall!.copyWith(fontSize: 17.5, fontWeight: FontWeight.w600),
        ),
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                textName,
                style: textTheme.headlineSmall!.copyWith(fontSize: 14.5, fontWeight: FontWeight.w400),
              ),
            ),
          ],
        ),
