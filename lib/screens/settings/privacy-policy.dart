              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SubHeadingText(
                        textNo: '2.1.1 	', textName: AppStrings.sectionP211),
                    SubHeadingText(
                        textNo: '2.1.2	', textName: AppStrings.sectionP212),
                    SubHeadingText(
                        textNo: '2.1.3	', textName: AppStrings.sectionP213),
                    SizedBox(height: 10),
                    HeadingText(
                        textName:
                    ...
                    SubHeadingText(
                        textNo: '9.2.1 	', textName: AppStrings.sectionP921),
                    SubHeadingText(
                        textNo: '9.2.2 	', textName: AppStrings.sectionP922),
                    SubHeadingText(
                        textNo: '9.2.3 	', textName: AppStrings.sectionP923),
                    SubHeadingText(
                        textNo: '9.2.4 	', textName: AppStrings.sectionP924),
                    SizedBox(height: 10),
                    HeadingText(textName: '10.	Cookies'),
                    SubHeadingText(
                        textNo: '10.1.	', textName: AppStrings.sectionP101),
                    SubHeadingText(
                        textNo: '10.2.	', textName: AppStrings.sectionP102),
                    SizedBox(height: 10),
                    HeadingText(textName: '11. Third-Party Websites'),
                    SubHeadingText(
                        textNo: '11.1.	', textName: AppStrings.sectionP111),
                    SubHeadingText(
                        textNo: '11.2.	', textName: AppStrings.sectionP112),
                    SubHeadingText(
                        textNo: '11.3.	', textName: AppStrings.sectionP113),
                    SizedBox(height: 10),
                    HeadingText(textName: '12.	Updating of Privacy Policy '),
                    SubHeadingText(
                        textNo: '12.1.	', textName: AppStrings.sectionP1221),
                    SubHeadingText(
                        textNo: '12.2.	', textName: AppStrings.sectionP1222),
                    SizedBox(height: 10),
