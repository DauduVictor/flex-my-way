...
class JoinedFlexDetails extends StatefulWidget {

  static const String id = "joinedFlexDetails";
  const JoinedFlexDetails({Key? key}) : super(key: key);

  @override
  _JoinedFlexDetailsState createState() => _JoinedFlexDetailsState();
}

class _JoinedFlexDetailsState extends State<JoinedFlexDetails> {
