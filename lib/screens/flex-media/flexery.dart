        ...
        child: DismissKeyboard(
          child: SingleChildScrollView(
            child: Container(
              ...
              child: GetBuilder<FlexeryController>(builder: (controller) {
                return Column(
                  children: [
                          ...
                          return CircleAvatar(
                            ...
                            child: TextButton(
                              ...
                              style: TextButton.styleFrom(
                                padding:
                                    const EdgeInsets.fromLTRB(11, 8, 12, 8),
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                contentPadding:
                                    const EdgeInsets.fromLTRB(5, 18, 5, 5),
                            ...
                            child: GridView.builder(
                              itemBuilder: (BuildContext context, int index) {
                                return GestureDetector(
                                  onTap: () {
                                    _showImageDialog(
                                        controller.flexery, index, context);
                                  },
                                  child: Container(
